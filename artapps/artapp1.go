...
`)
  ...
  validateNum = 4
  shapeHash, _, _, err := canvas.AddShape(validateNum, bal.PATH, "M 10 10 h 20 v 20 h -20 z", "blue", "red")
  waitingChannel <- true
...
`)
  ...
  go waitingDots(waitingChannel)
  validateNum = 4
  _, _, _, err = canvas.AddShape(validateNum, bal.PATH, "M 55 400 h 10 v 10 h -10 z", "blue", "red")
  waitingChannel <- true
